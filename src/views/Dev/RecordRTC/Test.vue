        ...
        <div class="video__partner">
            <div>
                ...
                <select id="audioSource">
                    <option v-for="(item, index) in audioSourceOption" :key="index" :value="item.value">{{ item.text }}
                    </option>
                </select>
            </div>
            <div>
                ...
                <select id="audioOutput">
                    <option v-for="(item, index) in audioOutputOption" :key="index" :value="item.value">{{ item.text }}
                    </option>
                </select>
            </div>
            <!-- <div>
          ...
          <select id="audioInput">
            ...
            <div>
                ...
                <select id="videoSource">
                    <option v-for="(item, index) in videoSourceOption" :key="index" :value="item.value">{{ item.text }}
                    </option>
                </select>
            </div>
            <!-- <div>
          ...
          <select id="filter">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <video id="recordLocalVideo" ref="recordLocalVideo" class="video__myself" controls width="340px"
                            height="180px" />
                    </td>
                    <td>
